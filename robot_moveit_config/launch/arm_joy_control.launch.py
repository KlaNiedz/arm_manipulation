...
def generate_launch_description():
    ...
    servo_yaml = load_yaml("robot_moveit_config", "config/six_dof_arm_simulated_config.yaml")
    ...
    ros2_control_node = Node(
        ...
        output="screen",
        arguments=["--controller-manager-timeout", "500"],
    ...
    #     remappings=[
    #         ('/cmd_vel_in', '/cmd_vel'),         # Remap input topic to your current cmd_vel topic
    #         ('/cmd_vel_out', '/diff_cont/cmd_vel')  # Remap output topic to the expected command topic
    #     ]
    # )
    ...
    container = ComposableNodeContainer(
        name="moveit_servo_six_dof_container",
        namespace="/",
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                plugin="servo_controller::JoyToServoPub",
                name="controller_to_servo_node",
                remappings=[
                    ("/joy", "/joy"),
                    ("/servo_server/delta_twist_cmds", "/servo_node/delta_twist_cmds"),
                ],
            ),
            ComposableNode(
                package="robot_state_publisher",
