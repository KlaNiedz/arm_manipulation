...
def generate_launch_description():
    pkgPath = launch_ros.substitutions.FindPackageShare(package='robot_simulation').find('robot_simulation')
    urdfModelPath= os.path.join(pkgPath, 'urdf/six_dof_arm.urdf')
